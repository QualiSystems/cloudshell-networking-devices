...
class TestConnectivityRunner(unittest.TestCase):
    ...
    @mock.patch("cloudshell.devices.runners.connectivity_runner.serialize_to_json", mock.MagicMock())
    @mock.patch("cloudshell.devices.runners.connectivity_runner.jsonpickle", mock.MagicMock())
    @mock.patch("cloudshell.devices.runners.connectivity_runner.JsonRequestDeserializer")
    def test_apply_connectivity_changes_set_vlan_action_success(
            self, json_request_deserializer_class, thread_class):
